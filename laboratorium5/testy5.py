...
if __name__ == "__main__":
    ...
    if chessboard.row_column() or chessboard.diagonal() or chessboard.column_row():
        print("Szachują się")
    else:
...
class test_chessboard(unittest.TestCase):
    def setUp(self):
        self.chessboard2 = Chessboard(2)
    def test_queens(self):
        self.assertEqual(N_queens, len(chessboard.table_of_positions))
    def test_checking_row(self):
        self.chessboard2.row_table = [1, 1]
        self.chessboard2.column_table = [1, 2]
        self.assertEqual(self.chessboard2.row_column(), True)
    def test_checking_column(self):
        self.chessboard2.row_table = [1, 1]
        self.chessboard2.column_table = [1, 2]
        self.assertNotEqual(self.chessboard2.column_row(), True)
    def test_checking_row2(self):
        self.chessboard2.row_table = [2, 1]
        self.chessboard2.column_table = [1, 2]
        self.assertNotEqual(self.chessboard2.row_column(), True)
    def test_checking_diagonal(self):
        self.chessboard2.table_of_positions = [(1, 1), (66, 66)]
        self.assertEqual(self.chessboard2.diagonal(), True)
    def test_checking_diagonal2(self):
        self.chessboard2.table_of_positions = [(1, 1), (25, 66)]
        self.assertNotEqual(self.chessboard2.diagonal(), True)
